...
*/
      ...
      /*  int suma = 0;
        ...
        if (numar>=0){
            ...
            System.out.println("Produsul numerelor pare cuprinse intre 1 si " + numar + " este egal cu " + produs);
        }else{
            int suma = 0;
for (int i=0; i>=numar; i--){
    if (i%2!=0){
        suma +=i;
            ...
            System.out.println("Suma numerelor impare cuprinde intre 0 si " + numar + " este egal " + suma);
        }
    }
}
